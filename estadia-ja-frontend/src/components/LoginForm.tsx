        ...
        <div className="flex h-screen overflow-hidden font-sans bg-[#F1FAEE]">
            ...
            <div className="w-full md:w-2/3 flex items-center justify-center p-6 md:p-12 overflow-y-auto">
                <div className="w-full max-w-lg">
                    ...
                    <div className="flex justify-between text-sm font-medium text-[#1D3557] mt-4">
                    ...
                    <button
                        type="button"
                        className="w-full py-3 rounded-full bg-[#1D3557] text-white font-semibold text-lg transition-colors mt-6 flex items-center justify-center opacity-50 cursor-not-allowed"
                        disabled
                    >
                        <GoogleIcon />
                        Login com o google
