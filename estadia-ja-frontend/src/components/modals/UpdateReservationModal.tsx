...
export function UpdateReservationModal({
  ...
  return (
    <div
      ...
      data-testid='update-reservation-modal-backdrop'
    >
      <div className='flex w-full max-w-xl flex-col rounded-2xl bg-white p-6 shadow-xl'>
        <div className='mb-4 flex items-center justify-between'>
          <h2
            ...
            data-testid='update-reservation-modal-title'
          >
          ...
          <button
            ...
            disabled={isLoading}
            data-testid='update-reservation-modal-close-button'
          >
        ...
        <div className='flex justify-center'>
          <DayPicker
            ...
            data-testid='update-reservation-modal-daypicker'
          />
        </div>
        ...
        <button
          ...
          data-testid='update-reservation-modal-confirm-button'
        >
