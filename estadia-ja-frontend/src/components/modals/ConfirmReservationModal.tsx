...
export function ConfirmReservationModal({
  ...
  return (
    <div
      ...
      data-testid='confirm-reservation-modal-backdrop'
    >
      <div className='flex w-full max-w-md flex-col rounded-2xl bg-white p-6 shadow-xl'>
        <div className='mb-4 flex items-center justify-between'>
          <h2
            ...
            data-testid='confirm-reservation-modal-title'
          >
            Confirmar Reserva
          </h2>
          <button
            ...
            disabled={isLoading}
            data-testid='confirm-reservation-modal-close-button'
          >
        ...
        <div className='mb-6 rounded-lg bg-[#A8DADC] p-4 text-center'>
          <p className='text-sm font-medium text-[#1D3557]'>
            Check-in:
            <strong data-testid='confirm-reservation-checkin-date'>
              {fromDate}
            </strong>
          </p>
          <p className='text-sm font-medium text-[#1D3557]'>
            Checkout:
            <strong data-testid='confirm-reservation-checkout-date'>
              {toDate}
            </strong>
          </p>
        </div>
        ...
        <button
          ...
          data-testid='confirm-reservation-modal-confirm-button'
        >
        ...
        <button
          ...
          data-testid='confirm-reservation-modal-cancel-button'
        >
          Cancelar
        </button>
      </div>
