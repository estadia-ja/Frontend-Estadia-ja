type BecomeOwnerBlockProps = {
  onClick: () => void;
};

export function BecomeOwnerBlock({ onClick }: BecomeOwnerBlockProps) {
  return (
    <div className='flex w-full flex-col items-center justify-between rounded-lg p-6 md:flex-row'>
